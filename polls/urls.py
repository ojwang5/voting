...
urlpatterns = [
    ...
    path('phone-login/set-password/', views.phone_set_password, name='phone_set_password'),
    
    path('register/', views_register.register, name='register'),
    path('elections/<int:election_id>/', views.detail, name='detail'),
    path('elections/<int:election_id>/register/', views.register_for_election, name='register_for_election'),
    ...
    path('candidates/<int:candidate_id>/view/', views_admin.view_candidate, name='view_candidate'),
